...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='slot',
            name='allowed_highschool_levels',
            field=models.ManyToManyField(blank=True, related_name='_core_slot_allowed_highschool_levels_+',
                                         to='core.HighSchoolLevel', verbose_name='Allowed high school levels'),
        ),
        migrations.AddField(
            model_name='slot',
            name='allowed_post_bachelor_levels',
            field=models.ManyToManyField(blank=True, related_name='_core_slot_allowed_post_bachelor_levels_+',
                                         to='core.PostBachelorLevel', verbose_name='Allowed post bachelor levels'),
        ),
        migrations.AddField(
            model_name='slot',
            name='allowed_student_levels',
            field=models.ManyToManyField(blank=True, related_name='_core_slot_allowed_student_levels_+',
                                         to='core.StudentLevel', verbose_name='Allowed student levels'),
        ),
