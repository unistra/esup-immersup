    ...
    if immersion_rappel_int:
        try:
            ...
            immersion_annulation_int = MailTemplate.objects.create(
                ...
                description="Mail envoyé à un intervenant en cas de déinscription après la date de fin d'inscription à un créneau. Le mail sera envoyé uniquement aux intervenants qui auront accepté l'envoi dans les paramètres.",
