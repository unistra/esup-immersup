...
class SlotMassUpdateForm(forms.Form):
    ...
    allowed_establishments = forms.ModelMultipleChoiceField(queryset=Establishment.objects.all(), required=False)
    allowed_highschools = forms.ModelMultipleChoiceField(queryset=HighSchool.objects.all(), required=False)
    allowed_highschool_levels = forms.ModelMultipleChoiceField(queryset=HighSchoolLevel.objects.all(), required=False)
    allowed_student_levels = forms.ModelMultipleChoiceField(queryset=StudentLevel.objects.all(), required=False)
    allowed_post_bachelor_levels = forms.ModelMultipleChoiceField(queryset=PostBachelorLevel.objects.all(), required=False)
    allowed_bachelor_types = forms.ModelMultipleChoiceField(queryset=BachelorType.objects.all(), required=False)
    allowed_bachelor_mentions = forms.ModelMultipleChoiceField(queryset=BachelorMention.objects.all(), required=False)
    allowed_bachelor_teachings = forms.ModelMultipleChoiceField(queryset=GeneralBachelorTeaching.objects.all(), required=False)
