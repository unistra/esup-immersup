    ...
    for slot in slots.order_by('date', 'start_time'):
        ...
        data = {
            ...
            'restrictions': {
                ...
                'allowed_bachelor_series': [serie.label for serie in slot.allowed_bachelor_series.all()],
                'allowed_bachelor_teachings': [mention.label for mention in slot.allowed_bachelor_teachings.all()],
            },
