...
@task
def preprod_angers():
    """Define preprod stage for Angers instance"""
    env.roledefs = {
        'web': ['saas-angers-pprd-1.srv.unistra.fr', 'saas-angers-pprd-2.srv.unistra.fr'],
        'lb': ['saas-angers-pprd-1.srv.unistra.fr', 'saas-angers-pprd-2.srv.unistra.fr'],
        'shib': ['rp-shib3-pprd-1.srv.unistra.fr', 'rp-shib3-pprd-2.srv.unistra.fr'],  }

    # env.user = 'root'  # user for ssh
    env.application_name = 'immersup_angers'
    env.backends = env.roledefs['web']
    env.server_name = 'angers.pprd.immersup.fr'
...
def prod_angers():
    """Define preprod stage for Angers instance"""
    env.roledefs = {
        'web': ['saas-angers-prod-1.srv.unistra.fr', 'saas-angers-prod-2.srv.unistra.fr'],
        'lb': ['saas-angers-prod-1.srv.unistra.fr', 'saas-angers-prod-2.srv.unistra.fr'],
        'shib': ['rp-shib3-prod-1.srv.unistra.fr', 'rp-shib3-prod-2.srv.unistra.fr'],  }

    # env.user = 'root'  # user for ssh
    env.application_name = 'immersup_angers'
    env.backends = env.roledefs['web']
    env.server_name = 'angers.immersup.fr'
